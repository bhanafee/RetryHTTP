...
public class RetryAfterParserTest {
  ...
  @ParameterizedTest
  @CsvSource({"0, 0", "1, 1", "100, 100", "00000, 0", "00001, 1", "999999999, 999999999"})
  ...
  @ParameterizedTest
  @CsvSource({"0.0, 0", "0.5, 500", "1.5, 1500", "0000.0, 0", "00.001, 1"})
  ...
  @ParameterizedTest
  @CsvSource({"0, 0", "1, 1", "2, 2", "10, 10", "03, 3"})
  ...
  @ParameterizedTest
  @ValueSource(strings = {"0.0", "1.0", "-1", "Thu, 02 Jan 2003 01:23:45 GMT", "garbage"})
  ...
  @ParameterizedTest
  @ValueSource(strings = {"-1", "Thu, 02 Jan 2003 01:23:45 GMT", "garbage"})
  ...
  void testDatePast() {
    ...
    final RetryAfterParser parser =
        RetryAfterParser.strict(InstantSource.fixed(TEST_INSTANT.plus(EXPECTED)));
  ...
  void testStrictDates(final String header) {
    ...
    final RetryAfterParser parser =
        RetryAfterParser.strict(InstantSource.fixed(TEST_INSTANT.minus(EXPECTED)));
  ...
  @ParameterizedTest
  @ValueSource(strings = {"1.0", "-1", "2003-01-02T01:23:45Z", "", "garbage"})
  ...
  void testExtendedDates(final String header) {
    ...
    // Set the parser clock to a fixed time EXPECTED seconds before TEST_INSTANT
    final RetryAfterParser parser =
        RetryAfterParser.extended(InstantSource.fixed(TEST_INSTANT.minus(EXPECTED)));
