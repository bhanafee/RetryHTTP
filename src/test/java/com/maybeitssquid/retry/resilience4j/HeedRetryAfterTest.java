...
public class HeedRetryAfterTest {
  ...
  private static final Either<Throwable, HttpServletResponse> LEFT =
      Either.left(new Exception("test"));
  ...
  public HeedRetryAfterTest(
      @Mock HttpServletResponse response, @Mock IntervalBiFunction<HttpServletResponse> wrapped) {
